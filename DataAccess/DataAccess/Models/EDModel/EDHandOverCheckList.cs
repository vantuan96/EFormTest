...
{
    public class EDHandOverCheckList: IEntity
    {
        public EDHandOverCheckList()
        {
            this.HandOverCheckListDatas = new HashSet<EDHandOverCheckListData>();
        }
        ...
        public virtual ICollection<EDHandOverCheckListData> HandOverCheckListDatas { get; set; }
